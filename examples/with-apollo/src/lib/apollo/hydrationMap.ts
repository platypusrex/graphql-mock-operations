...
import { bookQuery, usersQuery, userQuery, booksByAuthorIdQuery } from '../../gql';
...
export const hydrationMap = generateHydrationMap({
  ...
  booksByAuthor: ({ query }): QueryOptions<BooksByAuthorIdQueryVariables, BooksByAuthorIdQuery> => ({
