...
export type AddressFragment = { __typename?: 'Address', addressLineOne: string, city: string, state: string, zip: string };
...
export type BooksQuery = { __typename?: 'Query', books: Array<{ __typename?: 'Book', id: string, title: string, numPages: number, authorId: string }> };
...
export type BooksMockOperationResult = {
	books: Array<{ __typename?: 'Book', id: string, title: string, numPages: number, authorId: string }>
};
