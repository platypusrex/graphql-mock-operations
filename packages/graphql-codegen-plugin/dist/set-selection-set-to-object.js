...
class SelectionSetToObject extends visitor_plugin_common_1.SelectionSetToObject {
    _processor;
    _scalars;
    _schema;
    _convertName;
    ...
    _buildGroupedSelections() {
        ...
        const grouped = (0, visitor_plugin_common_1.getPossibleTypes)(this._schema, this._parentSchemaType).reduce((prev, type) => {
    ...
    _buildSelectionSetObject(parentSchemaType, selectionNodes) {
            ...
            if ('kind' in selectionNode) {
                if (selectionNode.kind === 'Field') {
                    if (!selectionNode.selectionSet) {
                        ...
                        const fieldName = (0, visitor_plugin_common_1.getFieldNodeNameValue)(selectionNode);
                        ...
                        if (!linkFieldNode) {
                            ...
                            linkFieldNode = {
                                ...
                                field: {
                                    ...linkFieldNode.field,
                                    selectionSet: (0, visitor_plugin_common_1.mergeSelectionSets)(linkFieldNode.field.selectionSet, selectionNode.selectionSet),
                                },
                            };
                        }
        ...
        for (const { field, selectedFieldType } of linkFieldSelectionSets.values()) {
            ...
            const isConditional = (0, visitor_plugin_common_1.hasConditionalDirectives)(field) || inlineFragmentConditional;
            linkFields.push({
        ...
        const transformed = [
            ...
            ...this._processor.transformPrimitiveFields(parentSchemaType, Array.from(primitiveFields.values()).map(field => ({
                isConditional: (0, visitor_plugin_common_1.hasConditionalDirectives)(field),
