...
export var WithApolloClient = function WithApolloClient(Story) {
  var _useState = useState([]),
      _useState2 = _slicedToArray(_useState, 2),
      operationsArr = _useState2[0],
      setOperationsArr = _useState2[1];

  var _ref = useParameter(PARAM_KEY, {}),
  ...
  useEffect(function () {
    setGlobals(_defineProperty({}, "".concat(ADDON_ID, "/operations"), operationsArr));
  }, [operationsArr]);
  var handleResolvedOperation = useCallback(function (operationMeta) {
  ...
  return /*#__PURE__*/_jsx(Provider, _objectSpread(_objectSpread({}, providerProps), {}, {
